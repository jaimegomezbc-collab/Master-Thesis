...
if __name__ == "__main__":
    ...
    for image_name in os.listdir(flair_folder):
        output_dir = os.path.join("/cs/student/project_msc/2025/aibh/jgomezbe/Master-Thesis/Explanations",
                                  image_name[:-4])
        os.makedirs(output_dir, exist_ok=True)
        if os.path.exists(os.path.join(output_dir, "LIME_explanation.png")):
